...
export function convertCypressResults(parameters: {
    context: {
...
function aggregateXrayStatus(
    ...
    if (statuses.length > 1) {
        ...
        return getXrayCypressStatus(CypressStatus.FAILED, isCloudEnvironment === true, xrayStatus);
    }
    return getXrayCypressStatus(statuses[0], isCloudEnvironment === true, xrayStatus);
}
