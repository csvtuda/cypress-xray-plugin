...
void describe(relative(cwd(), __filename), () => {
    void describe(uploadFeatureFiles.name, () => {
        void it("does nothing if no feature files are specified", async (context) => {
            ...
            const result = await uploadFeatureFiles({
                clients: {
        ...
        void it("logs nothing for fully synchronized feature files", async (context) => {
            ...
            assert.deepStrictEqual(result, [
                {
                    affectedIssues: ["CYP-123", "CYP-456"],
                    filePath: "/path/to/feature-file.feature",
                    mismatches: { onlyInFeatureFile: [], onlyInXray: [] },
                },
                {
                    affectedIssues: ["CYP-789"],
                    filePath: "/path/to/other-feature-file.feature",
                    mismatches: { onlyInFeatureFile: [], onlyInXray: [] },
                },
            ]);
        ...
        void it("logs mismatches for partially synchronized feature files", async (context) => {
            ...
            assert.deepStrictEqual(result, [
                {
                    affectedIssues: ["CYP-456"],
                    filePath: "/path/to/feature-file.feature",
                    mismatches: {
                        onlyInFeatureFile: ["CYP-123"],
                        onlyInXray: ["CYP-789", "CYP-987"],
                    },
                },
                {
                    affectedIssues: [],
                    filePath: "/path/to/other-feature-file.feature",
                    mismatches: { onlyInFeatureFile: ["CYP-789"], onlyInXray: [] },
                },
                {
                    affectedIssues: [],
                    filePath: "/path/to/third-feature-file.feature",
                    mismatches: { onlyInFeatureFile: [], onlyInXray: ["CYP-42"] },
                },
            ]);
            assert.deepStrictEqual(
