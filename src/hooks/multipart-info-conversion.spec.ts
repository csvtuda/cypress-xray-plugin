...
void describe(relative(cwd(), __filename), () => {
    void describe(convertMultipartInfoCloud.name, () => {
        void it("returns cloud info data", () => {
            const result = convertMultipartInfoCloud({
                cypress: {
                    config: {
                        browserName: "Firefox",
